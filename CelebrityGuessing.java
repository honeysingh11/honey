package com.myappcompany.rob.celebrityguessing;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String[] splitResult = result.split("<li class=\"bh-top-100-celebs-slide slick-slide slick-current slick-active\">");
